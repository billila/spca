...
adata2.obsm["X_pca"] = PCA(n_components=n_components, svd_solver = "full", output_type="numpy").fit_transform(adata.X)
...
start_time = time.time()
adata2.obsm["X_pca"] = PCA(n_components=n_components, svd_solver = "jacobi", output_type="numpy").fit_transform(adata.X)
p = PCA(n_components=n_components, output_type="numpy")
